...
export const ANALYTICS_ENDPOINTS = {
  events: `${env.VITE_API_URL || 'https://api.esportexe.com'}/v1/analytics/events`,
  batch: `${env.VITE_API_URL || 'https://api.esportexe.com'}/v1/analytics/batch`,
  dashboard: `${env.VITE_WS_URL || 'wss://api.esportexe.com'}/v1/analytics/dashboard`
} as const
