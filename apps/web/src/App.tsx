...
const _StreamingPredictionPanel = lazy(() => import('./components/StreamingPredictionPanel'));
...
const prefetchHub = (hubName: string): void => {
...
const HubLoadingFallback = (): React.ReactNode => (
...
const _InlineSkeleton = (): React.ReactNode => (
...
const PageTransition = ({ children, hubId }: PageTransitionProps): React.ReactNode => {
  const variants = {
    initial: { 
      opacity: 0, 
      y: 20,
