/**
 * EXE Companion App
 * React Native / Expo app stub for eSports-EXE mobile companion.
 *
 * Phase 5 stub — imports @esportexe/types and @esportexe/ui (gate 5.4).
 * Full implementation planned for Phase 5 (Month 3+).
 * [Ver001.000]
 */
import React from 'react'
import { GameNodeBadge } from '@esportexe/ui'
