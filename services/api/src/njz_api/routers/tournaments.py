...
@router.get(
    ...
    description="Get list of tournaments with circuit breaker protected external API calls.",
)
...
@router.post(
    ...
    description="Submit match results with circuit breaker protection for processing.",
)
...
@router.get(
    ...
    description="Get current status of all circuit breakers for monitoring.",
)
