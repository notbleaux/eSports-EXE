...
## Templates
- `templates/layer-component.tsx` — Layer component template
- `templates/spatial-hook.ts` — Custom spatial data hook
- `templates/visualization-test.tsx` — Component test template
- `templates/webgl-renderer.ts` — WebGL renderer base class

## Examples
- `examples/sator-layer-example.tsx` — Complete L1 implementation
- `examples/layer-composition.tsx` — Multi-layer composition
- `examples/spatial-data-types.ts` — TypeScript type definitions
