...
class TestSubscribeEndpoint:
    ...
    def test_subscribe_failure(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            mock_service.initialize = AsyncMock()
            mock_service.subscribe.return_value = False
...
class TestUnsubscribeEndpoint:
    ...
    def test_unsubscribe_not_found(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            mock_service.unsubscribe.return_value = False
    ...
    def test_unsubscribe_all_success(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            mock_service.unsubscribe_all.return_value = True
    ...
    def test_unsubscribe_all_none_found(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            mock_service.unsubscribe_all.return_value = False
...
class TestPreferencesEndpoints:
    ...
    def test_update_preferences_success(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            mock_service.get_preferences.return_value = MagicMock(
                global_enabled=True,
                categories={}
            )
            mock_service.update_preferences.return_value = True
...
class TestStatsEndpoint:
    ...
    def test_get_stats(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            ...
            mock_service.get_stats.return_value = NotificationStats(
...
class TestClickTrackingEndpoint:
    ...
    def test_mark_notification_clicked(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            mock_service.mark_clicked.return_value = True
    ...
    def test_mark_notification_clicked_not_found(self):
        ...
        with patch('src.notifications.routes.push_service') as mock_service:
            mock_service.mark_clicked.return_value = False
