 ...
 * NJZ Platform v2.0 — Unified 4-Hub Architecture
 * 
 * The central orchestrator for the SATOR/ROTAS twin-file platform.
 * Implements React Router v6 with Framer Motion page transitions,
 * Zustand state management, and error boundary protection.
 * 
 * @module App
 * @version 2.0.0
 * @since 2024-03
 ...
 * Provides smooth enter/exit animations with reduced motion support
 */
 ...
 * Tracks navigation and manages hub state transitions
 */
 ...
 * Renders the complete NJZ Platform with all hubs
 */
function App() {
      ...
      <main className="relative">
        <AnimatePresence mode="wait">
          <Routes location={location} key={location.pathname}>
            <Route path="/" element={<PageTransition hubId="central"><CentralGrid /></PageTransition>} />
            <Route path="/sator" element={<PageTransition hubId="sator"><SATORHub /></PageTransition>} />
            <Route path="/rotas" element={<PageTransition hubId="rotas"><ROTASHub /></PageTransition>} />
            <Route path="/info" element={<PageTransition hubId="info"><InformationHub /></PageTransition>} />
            <Route path="/games" element={<PageTransition hubId="games"><GamesHub /></PageTransition>} />
              ...
              <PageTransition hubId="404">
                <div className="min-h-screen flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <a href="/" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-signal-cyan text-void-black font-medium hover:shadow-glow-cyan transition-all">
                      Return to Central
                    </a>
                  </div>
                </div>
