...
## Templates
- `templates/component-status.md` — Component status template
- `templates/adr-template.md` — Architecture Decision Record
- `templates/gap-analysis.md` — Gap analysis format
- `templates/integration-spec.md` — Integration specification

## Examples
- `examples/sample-adr.md` — Sample ADR
- `examples/component-matrix.md` — Component tracking example
- `examples/cross-reference.md` — Cross-reference example
